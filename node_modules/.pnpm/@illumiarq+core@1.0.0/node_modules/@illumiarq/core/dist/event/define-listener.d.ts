 ...
 * );
 */
export declare function defineListener<S extends ZodTypeAny>(event: EventDefinition<S>, handler: (payload: z.infer<S>) => Promise<void>): ListenerDefinition<S>;
//# sourceMappingURL=define-listener.d.ts.map