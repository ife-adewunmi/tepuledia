...
export async function optimizeForProduction(cwd = process.cwd()) {
    writeLine();
...
export async function clearOptimizationCaches(cwd = process.cwd()) {
    writeLine();
...
//# sourceMappingURL=cache-workflows.js.map