 ...
 */
export function buildVercelFunction(cwd = process.cwd()) {
    writeLine();
    ...
    writeLine(`  ${ui.dim('Add vercel.json rewrite: { "source": "/(.*)", "destination": "/api/index" }')}`);
    writeLine();
    return 0;
}
//# sourceMappingURL=build-vercel-fn.js.map