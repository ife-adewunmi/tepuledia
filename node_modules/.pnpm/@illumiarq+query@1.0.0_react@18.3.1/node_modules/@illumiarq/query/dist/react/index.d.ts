 ...
 */
export declare function toTanStackOptions(opts: LoaderQueryOptions): {
 ...
 */
export declare function createLoaderQuery(key: readonly unknown[], loader: BoundLoader, input: unknown): {
    queryKey: readonly unknown[];
    queryFn: () => Promise<unknown>;
};
