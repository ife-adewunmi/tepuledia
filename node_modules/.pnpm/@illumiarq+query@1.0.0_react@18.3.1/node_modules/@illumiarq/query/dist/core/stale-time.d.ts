 ...
 */
export declare function loaderStaleTime(routeStaleTime: number): number;
/**
 ...
 */
export declare function createLoaderQueryOptions(key: readonly unknown[], loader: BoundLoader, input: unknown, staleTime: number): LoaderQueryOptions;
//# sourceMappingURL=stale-time.d.ts.map