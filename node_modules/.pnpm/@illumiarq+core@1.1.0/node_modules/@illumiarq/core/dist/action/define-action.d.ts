 ...
 */
export type ActionFn<TInput, TOutput, TDeps extends unknown[] = []> = (input: TInput, ...deps: TDeps) => Promise<TOutput>;
/**
 ...
 * );
 */
export declare function defineAction<TFn extends (input: any, ...deps: any[]) => Promise<any>>(fn: TFn, _metadata?: ActionMetadata): TFn;
