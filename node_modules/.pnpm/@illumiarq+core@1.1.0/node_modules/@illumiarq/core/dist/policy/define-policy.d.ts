 ...
 */
export type AbilityMap<TUser, TResource = void> = Record<string, (user: TUser, resource?: TResource) => boolean | Promise<boolean>>;
 ...
 * });
 */
export declare function definePolicy<TUser, TResource = void>(abilities: AbilityMap<TUser, TResource>): PolicyDefinition<TUser, TResource>;
//# sourceMappingURL=define-policy.d.ts.map