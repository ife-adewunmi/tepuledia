...
export class MissingRenderStrategyError extends LumiARQError {
    constructor(path) {
        super(`Web route "${path}" is missing a required render declaration ('static' | 'dynamic').`, 500);
    }
}
...
export class InvalidApiRouteError extends LumiARQError {
    constructor(path, field) {
        super(`API route "${path}" must not declare "${field}" — that field is for web routes only.`, 500);
    }
}
