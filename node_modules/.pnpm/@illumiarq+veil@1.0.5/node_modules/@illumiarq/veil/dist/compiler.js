...
export async function viewCache(cwd = process.cwd(), options = {}) {
    ...
    if (existsSync(langPath)) {
        Object.assign(lang, JSON.parse(readFileSync(langPath, 'utf8')));
    }
    else {
            ...
            if (existsSync(langPath) && statSync(langPath).isDirectory()) {
                ...
                for (const file of readdirSync(langPath)) {
                    if (file.endsWith('.json')) {
                        ...
                        try {
                            Object.assign(lang, JSON.parse(readFileSync(filePath, 'utf8')));
                        }
                        catch {
 ...
 */
export async function viewClear(cwd = process.cwd(), options = {}) {
